...
@section('container')
    <div class="contentabout">
        ...
        <div class="borderbungkus">
            <div
                class="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16  border-gray-200  lg:mx-10 lg:max-w-none lg:grid-cols-3">
                <article class="flex max-w-xl flex-col items-start justify-between">
                    <img src="/img/fachri.jpg" class="gambarabout">
